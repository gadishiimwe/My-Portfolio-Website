        ...
        <div className="flex items-center justify-center animate-fade-in">
          ...
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              I'm a young developer passionate about building modern digital
              experiences that blend beautiful design with powerful functionality
              — all at a budget-friendly cost. I create scalable solutions that make
              a real impact without breaking the bank.
            </p>
